\ raylib_structs.f
\
\ Type names are /Type (the byte size) so they do not hide example
\ buffers named music, font, mesh, model, image, texture, ray, ...
\ Short vector fields are Vector2.x etc. so they do not hide x/y/z/w.

include /home/dave/forth/raylib.f/linux/cstruct.f
...
/Texture extend /Texture2D
;struct

/Texture extend /TextureCubemap
;struct
...
/RenderTexture extend /RenderTexture2D
;struct
