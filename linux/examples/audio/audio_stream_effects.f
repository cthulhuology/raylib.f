\ Port of raylib examples/audio/audio_stream_effects.c
\ LPF/delay processors not bound; music stream still plays.
...
: example
   0 pause !
   screenWidth screenHeight z" raylib [audio] example - stream effects" InitWindow
   InitAudioDevice
   ...
   begin
      ...
      then
      music GetMusicTimePlayed music GetMusicTimeLength f/ 1e fmin timePlayed sf!
      BeginDrawing
         ...
         z" PRESS P TO PAUSE/RESUME" 208 280 20 LIGHTGRAY DrawText
         z" Stream LPF/delay processors not ported" 180 320 20 DARKGRAY DrawText
      EndDrawing
