...
: example
   ...
   shd z" /home/dave/Code/raylib/examples/shaders/resources/shaders/glsl330/gbuffer.vs" z" /home/dave/Code/raylib/examples/shaders/resources/shaders/glsl330/gbuffer.fs" LoadShader drop
   ...
   begin
      ...
      BeginDrawing
         ...
         camera BeginMode3D
            ...
            10 1e DrawGrid
         EndMode3D
         z" Deferred G-buffer shader on cube (no full G-buffer blit)" 10 10 20 DARKGRAY DrawText
         10 40 DrawFPS
      EndDrawing
