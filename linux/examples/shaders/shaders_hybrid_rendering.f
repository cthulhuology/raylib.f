...
: example
   ...
   shd 0 z" /home/dave/Code/raylib/examples/shaders/resources/shaders/glsl330/hybrid_raymarch.fs" LoadShader drop
   ...
   begin
      ...
      BeginDrawing
         ...
         camera BeginMode3D
            ...
            10 1e DrawGrid
         EndMode3D
         z" Hybrid raymarch/raster simplified" 10 10 20 DARKGRAY DrawText
         10 40 DrawFPS
      EndDrawing
