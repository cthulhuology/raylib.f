...
: example
   ...
   shd z" /home/dave/Code/raylib/examples/shaders/resources/shaders/glsl330/shadowmap.vs" z" /home/dave/Code/raylib/examples/shaders/resources/shaders/glsl330/shadowmap.fs" LoadShader drop
   ...
   begin
      ...
      BeginDrawing
         ...
         camera BeginMode3D
            ...
            10 1e DrawGrid
         EndMode3D
         z" Shadowmap simplified (no depth FBO)" 10 10 20 DARKGRAY DrawText
         10 40 DrawFPS
      EndDrawing
